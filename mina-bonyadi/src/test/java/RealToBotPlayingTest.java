...
import come.example.mancala.game.component.RuleManagementImpl;
import come.example.mancala.game.component.RealToBotPlaying;
...
public class RealToBotPlayingTest {

    @Mock
    private CommandHandler commandHandler;

    private RealToBotPlaying realToBotPlaying;

    @Before
    public void initMocks() {
        MockitoAnnotations.openMocks(this);
        RuleManagementImpl ruleHandler = new RuleManagementImpl();
        realToBotPlaying = new RealToBotPlaying(commandHandler, ruleHandler);
    }
